Predicting Income Based on Religiosity
================
...
We now have **a** dataset. We will further reduce the number of
...
Once transferred into Python, we will transform these variables into
